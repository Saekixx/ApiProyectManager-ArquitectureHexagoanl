...
@Service
public class FindActiveMemberByProjectId {
    ...
    public FindActiveMemberByProjectId(ProjectMemberRepository projectMemberRepository, ProjectRepository projectRepository, UserRepository userRepository) {
